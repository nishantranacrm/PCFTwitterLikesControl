...
export class TwitterLikesControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement)
	{
		...
		if (context.parameters.twitterProfileProperty == null) {
			this._value = "";
		}
		else {
			this._value = context.parameters.twitterProfileProperty.raw == null ? "" : context.parameters.twitterProfileProperty.raw;
		}
	...
	{
		return {
			twitterProfileProperty: this._value
		};
	}
	...
	private AddControls() {
		...
		this._anchorElement.setAttribute("href", "https://twitter.com/" + this._value +"/likes");
